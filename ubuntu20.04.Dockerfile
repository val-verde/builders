...
ENV DEB_PATH_BASE=${DEB_PATH_BASE:-${PACKAGE_ROOT}/${PACKAGE_BASE_NAME}-platform-sdk} \
...
ENV ANDROID_NDK_VERSION=r22 \
    BUILD_DEB_PATH=${DEB_PATH_BASE}/build-debs \
    SOURCE_DEB_PATH=${DEB_PATH_BASE}/source-debs
